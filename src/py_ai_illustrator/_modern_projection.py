"""Read-only semantic projection of modern Illustrator PrivateData CST.

The projection consumes decoded segments and the exact-span CST supplied by
:mod:`._modern_cst`; it never owns PDF parsing or synchronized mutation.
"""
...
if TYPE_CHECKING:
    from ._modern_container import ModernDiagnostic, PrivateDataSegment
...
def _story_texts(
    ...
    from ._modern_container import _PdfSyntaxParser
...
def _reduce_segment(
    ...
    *,
    ...
    from ._modern_container import ModernDiagnostic
