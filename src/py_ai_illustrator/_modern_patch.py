...
Target discovery and PDF/PrivateData patch mechanics are implemented here as
one write backend.  Public callers use the compatibility facade in
``modern_writing``; the operation layer remains responsible for planning and
orchestration.
"""
